...
GO
PRINT N'Dropping [dbo].[FK_Enrolment_Member]...';


GO
ALTER TABLE [dbo].[Enrolment] DROP CONSTRAINT [FK_Enrolment_Member];


GO
PRINT N'Dropping [dbo].[FK_Enrolment_Membership]...';


GO
ALTER TABLE [dbo].[Enrolment] DROP CONSTRAINT [FK_Enrolment_Membership];
